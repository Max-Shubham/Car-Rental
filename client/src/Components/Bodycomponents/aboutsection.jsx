            ...
            <div className="container mx-auto p-6 my-20">
                ...
                <div className="grid lg:grid-cols-2 ">
                    ...
                    <div className="w-full md:w-3/4 text-center md:text-start">
                        ...
                        <p className="text-base my-6 text-[#ffffff] font-sans">Whether you need a car for daily commuting, a weekend trip, or a business journey, we’ve got you covered.
                        ...
                        <p className="text-xl font-bold mt-10 text-[#ffffff]">We are at your service. Feel free to contact.</p>
                    </div>
                </div>
            </div>
        </>
