...
import car from "../images/car9.png"
            ...
            <section id="hero">
                <div className="container flex flex-col-reverse md:flex-row items-center  px-6 mx-auto mt-10 space-x-0 md:space-y-0">
                    ...
                    <div className="lg:px-16">
                        <h2 className="mb-4 max-w-md text-3xl font-bold text-center md:text-left lg:mt-24">Luxury on Rent!</h2>
                        <h1 className="mb-10 max-w-md text-4xl font-bold text-center md:text-5xl md:text-left">
                            Rent a <span className="text-orange">Car</span> in Minutes-Drive Your Way!
                        </h1>
